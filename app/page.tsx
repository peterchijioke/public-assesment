      ...
      try {
        ...
        const properties = response.slice(0, 4).map((property: any) => {
          ...
          return {
            ...
            location: `${property.region?.name || ""}, ${
              property.state?.name || "Nigeria"
            }`,
            price,
            propertyType,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground">
                The easiest real estate platform for buying, selling and renting
            ...
            <div className="relative">
              <img
                src={"/assets/hero-property-new.jpg"}
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Explore top-tier listings from trusted property owners across
                Nigeria
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>
                  <a href="/buy" className="hover:text-primary">
                    Buy
                  </a>
                </li>
                <li>
