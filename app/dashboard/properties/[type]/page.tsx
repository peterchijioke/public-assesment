...
import { Building2, Search, MapPin, Eye, Edit, Trash2, Home, CheckCircle2 } from "lucide-react";
...
const DashboardProperties = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (!propertyTypeSlug) {
        throw new Error(`Unknown property type: ${propertyToDelete.property_type}`);
      }
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <Select value={filterType} onValueChange={setFilterType}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="HouseForRent">Houses for Rent</SelectItem>
                  <SelectItem value="HouseForSale">Houses for Sale</SelectItem>
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredProperties.map((property, index) => (
              <Card key={property.id} className="hover-scale animate-fade-in" style={{animationDelay: `${0.2 + index * 0.05}s`}}>
                <div 
                ...
                >
                  {property.images && property.images.length > 0 && property.images[0].presigned_url ? (
                    <>
                      <img 
                ...
                <CardHeader>
                  ...
                  <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    ...
                    <span className="line-clamp-1">{property.state.name}, {property.region.name}</span>
                  </div>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-2xl font-bold text-primary">{getPropertyPrice(property)}</span>
                    {property.is_verified && (
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button 
                      ...
                      variant="outline" 
                      className="flex-1 gap-2"
                      onClick={() => navigate(`/dashboard/upload?edit=${property.id}`)}
                    >
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete "{propertyToDelete?.name || propertyToDelete?.address}"? 
