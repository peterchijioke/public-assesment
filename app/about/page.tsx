        ...
        <div className="container mx-auto max-w-4xl w-full">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-muted-foreground mb-6">
              To make property transactions in Nigeria simple, transparent, and
              accessible to everyone. We connect property seekers with verified
              listings and trusted property owners across the nation.
            </p>

            <h2 className="text-3xl font-bold mb-4">Why Choose Us</h2>
            <p className="text-muted-foreground">
              Our platform combines cutting-edge technology with deep local
              knowledge to provide the best real estate experience in Nigeria.
              Every property is verified, every transaction is secure, and every
              user is supported throughout their journey.
            </p>
          </div>
        </div>
      </div>
