...
import { Building2, Home, MapPin, Store, Users, CheckCircle, Clock, BarChart3 } from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  const propertyTypeCards = [
    { label: 'Houses for Rent', value: stats.properties_by_type.houses_for_rent, icon: Home, color: 'text-blue-500' },
    { label: 'Houses for Sale', value: stats.properties_by_type.houses_for_sale, icon: Building2, color: 'text-green-500' },
    { label: 'Lands', value: stats.properties_by_type.lands, icon: MapPin, color: 'text-orange-500' },
    { label: 'Flatshares', value: stats.properties_by_type.flatshares, icon: Home, color: 'text-purple-500' },
    { label: 'Shops', value: stats.properties_by_type.shops, icon: Store, color: 'text-red-500' },
  ];
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="mb-8 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button onClick={() => navigate('/admin/properties')} variant="outline">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Personal Users</CardTitle>
                <Users className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">{stats.total_personal_users}</div>
              </CardContent>
            </Card>
